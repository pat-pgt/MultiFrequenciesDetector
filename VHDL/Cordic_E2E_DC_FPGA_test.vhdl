...
entity Cordic_E2E_DC_FPGA_test is
  ...
  port (
    CLK                 : in std_logic := '0';
    RST                 : in std_logic;
    input_X             : in std_logic_vector( 10 downto 0); 
    input_Y             : in std_logic_vector( 10 downto 0); 
    ...
    X_Y_2_0             : out std_logic_vector( 17 downto 0 ); 
    Y_Y_2_0             : out std_logic_vector( 7 downto 0 ); 
    Z_Y_2_0             : out std_logic_vector( 17 downto 0 );
    metadata_note       : out std_logic_vector( 1 downto 0 );
